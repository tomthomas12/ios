...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Tom Thomas" => "tom.t@armiasystems.com" }
  # Or just: spec.author    = "Tom Thomas"
  # spec.authors            = { "Tom Thomas" => "tom.t@armiasystems.com" }
  # spec.social_media_url   = "https://twitter.com/Tom Thomas"
